# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2017-04-26 22:56
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('imagen_anuncio', models.FileField(upload_to='productos/%Y/%m/%d')),
                ('anuncio_imagen_fk', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='imagen', to='products.Anuncio')),
            ],
        ),
        migrations.CreateModel(
